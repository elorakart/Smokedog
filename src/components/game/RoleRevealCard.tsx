...
export function RoleRevealCard({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      <p className="mb-6 font-mono text-xs uppercase tracking-[0.3em] text-crimson/70">
        Envelope sealed
        ...
        >
          {!open ? (
            <div className="flex h-56 flex-col items-center justify-center">
              ...
              <p className="mt-4 font-mono text-[10px] uppercase tracking-widest text-crimson/40">
                Tap to unseal
              </p>
            </div>
          ) : (
